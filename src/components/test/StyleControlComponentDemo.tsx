...
const StyleControlComponentDemo = () => {
  ...
  const handleClick = (key, type, origin) => {
    console.log('key, type, origin: ', key, type, origin);
    console.log(type);
      ...
      <div className='left'>
        <div className='item'>
          ...
          <div>
            ...
            <div className='detail'><div>背景：</div><ColorComponent item={colorList}  type={'object'} origin='color' /></div>
          </div>
        </div>
        ...
        <div className='item'>
          ...
          <div>
            ...
            <div className='detail'>颜色：<ColorComponent item={colorList}  type={'text'}   origin='color' /></div>
        ...
        <div className='item'>
          ...
          <div>
            ...
            <div className='detail'>颜色：<ColorComponent item={colorList} type={'border'} origin='color' /></div>
          </div>
        </div>
