...
import DraggableComponent from 'src/components/cavanbj/draggableComponent/draggableComponent'
  ...
  return (
    <div className="min-h-screen p-4 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2  sm:items-start">
        ...
        <div style={{width: '100%'}}>
          <DraggableComponent >
            <div style={{ width: '150px', height: '150px', lineHeight: '150px', textAlign: 'center', backgroundColor: 'skyblue' }}>
              拖动我吧
            </div>
          </DraggableComponent>
          <br></br>
