  ...
  return (
    <div className="min-h-screen p-4 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2  sm:items-start">
        ...
        {/* 替换成自己完成的任务演示组件 */}
        <Link href="/demo/style-control-demo" legacyBehavior
        >
          <a className="text-2xl h-80 text-blue-500 border border-gray-300 p-2 w-full">StyleControlComponent Demostration</a>
        </Link>
